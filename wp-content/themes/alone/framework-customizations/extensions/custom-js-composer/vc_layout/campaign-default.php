...
<div class="bt-give">
  <?php if($goal && $raised && ($goal > $raised)){ ?>
    <div class="bt-price">
      <?php
        echo '<div class="bt-goal"><span>'.esc_html__('Goal', 'alone').'</span>'.$price_goal.'</div>'.
          '<div class="bt-raised"><span>'.esc_html__('Raised', 'alone').'</span>'.$price_raised.'</div>';
      ?>
    </div>
    <div class="bt-progress">
      <?php echo '<div class="bt-percent" style="height: '.esc_attr($percent).'%;"><span>'.$percent.'%</span></div>';?>
