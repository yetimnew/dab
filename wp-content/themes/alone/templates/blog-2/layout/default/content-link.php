...
if ( has_post_thumbnail() ) { // check if the post has a Post Thumbnail assigned to it.
  ...
  $image_background_elem = "<div class='post-link-image-background' style='{$style_inline}'></div>";
}
?>

<div class="post-header-link-wrap">
  <?php echo "{$image_background_elem}"; ?>
  <?php echo (isset($alone_post_options['link']) && ! empty($alone_post_options['link'])) ? $alone_post_options['link'] : ''; ?>
</div>
