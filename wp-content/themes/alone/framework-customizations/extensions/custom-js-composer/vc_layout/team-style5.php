	...
	<div class="bt-thumb_wrap">
		...
		<div class="bt-overlay">
			<div class="bt-overlay-inner">
				<?php
          if($email) echo '<div class="bt-email"><a href="mailto:'.esc_url($email).'"><i class="fa fa-envelope-o" aria-hidden="true"></i>'.$email.'</a></div>';
          if($phone) echo '<div class="bt-phone"><a href="tel:'.esc_url($phone).'"><i class="fa fa-mobile" aria-hidden="true"></i>'.$phone.'</a></div>';
