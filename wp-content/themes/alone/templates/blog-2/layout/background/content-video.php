...
<div class="post-item-container-wrap">
  <?php echo (isset($alone_post_options['video']) && ! empty($alone_post_options['video'])) ? '<div class="post-layout-creative-video-wrap" data-stellar-ratio=".8">' . $alone_post_options['video'] . '</div>' : ''; ?>
