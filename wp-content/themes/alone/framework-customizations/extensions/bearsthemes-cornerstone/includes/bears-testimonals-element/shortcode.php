...
$class = "bearsthemes-element bearsthemes-testimonals-element bearsthemes-testimonals-element-layout-{$layout} {$class}";
...
switch ($layout) {
  ...
  case 'carousel-2':
    $testimonals_temp .= '
    <div class="owl-carousel" data-bears-owl-carousel=\'{owl_options}\'>{content}</div>';
    break;
