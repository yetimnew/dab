 ...
 */
$type = $icon_fontawesome = $icon_openiconic = $icon_typicons = $icon_entypo = $icon_linecons = $color = $custom_color = $background_style = $background_color = $custom_background_color = $size = $align = $el_class = $el_id = $link = $css_animation = $css = $rel = $custom_action = '';
...
switch ($custom_action) {
  case 'lightbox':
    $lightbox_data = json_encode(array('selector' => '.vc_icon_element-link'));
    $lightbox_attr = 'data-bears-lightgallery='. $lightbox_data;
    break;
}
?>
<div <?php echo implode( ' ', $wrapper_attributes ); ?>
  ...
  <?php echo esc_attr($lightbox_attr); ?>>
