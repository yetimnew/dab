<?php
	...
	$social =  array();
	if($facebook) $social[] = '<li><a class="facebook" href="'.esc_url($facebook).'"><i class="fa fa-facebook"></i></a></li>';
	if($twitter) $social[] = '<li><a class="twitter" href="'.esc_url($twitter).'"><i class="fa fa-twitter"></i></a></li>';
	if($linkedin) $social[] = '<li><a class="linkedin" href="'.esc_url($linkedin).'"><i class="fa fa-linkedin"></i></a></li>';
	if($pinterest) $social[] = '<li><a class="pinterest" href="'.esc_url($pinterest).'"><i class="fa fa-pinterest"></i></a></li>';
	if($google_plus) $social[] = '<li><a class="google_plus" href="'.esc_url($google_plus).'"><i class="fa fa-google-plus"></i></a></li>';
	if($tumblr) $social[] = '<li><a class="tumblr" href="'.esc_url($tumblr).'"><i class="fa fa-tumblr"></i></a></li>';
	if($instagram) $social[] = '<li><a class="instagram" href="'.esc_url($instagram).'"><i class="fa fa-instagram"></i></a></li>';
	if($flickr) $social[] = '<li><a class="flickr" href="'.esc_url($flickr).'"><i class="fa fa-flickr"></i></a></li>';
