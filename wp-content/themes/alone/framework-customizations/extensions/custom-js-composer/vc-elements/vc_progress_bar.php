 ...
 */
$title = $values = $units = $bgcolor = $css = $custombgcolor = $customtxtcolor = $options = $el_class = $el_id = $css_animation = $custom_ui = '';
$output = '';
...
foreach ( $graph_lines_data as $line ) {
	...
	$output .= '<div class="vc_general vc_single_bar vc-custom-ui-'. $custom_ui .' '. ( ( isset( $line['color'] ) && 'custom' !== $line['color'] ) ?
