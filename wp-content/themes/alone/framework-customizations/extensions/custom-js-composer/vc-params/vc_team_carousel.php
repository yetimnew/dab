					...
					<?php
						if($rows == 1){
							while ( $wp_query->have_posts() ) { $wp_query->the_post();
								require get_template_directory().'/framework-customizations/extensions/custom-js-composer/vc_layout/team-'.$layout.'.php';
							}
						}else{
...
vc_map(array(
	'name' => esc_html__('Team Carousel', 'alone'),
    ...
    'params' => array(
		...
		array(
			...
			'value' => array(
				...
				esc_html__('Style4', 'alone') => 'style4',
				esc_html__('Style5', 'alone') => 'style5',
				esc_html__('Style6', 'alone') => 'style6',
			),
			'admin_label' => true,
